              ...
              <div class="col s12">
                <div class="card">
                  <div class="card-image">
                    <img class="responsive-img" src=${res.crestUrl} alt="${
              res.name
            }">
                  </div>
                    ...
                    <table class="responsive-table striped">
                      ...
                      ${res.squad
                        ...
                        <tr>
                          ...
                          <td>${data.name}</td>
                          <td>${
                            data.role === "COACH" ? "COACH" : data.position
                          }</td>
                        </tr>
                        `;
                        })
        ...
        const dataTeam = `
            <div class="row">
              <div class="col s12">
                <div class="card">
                  <div class="card-image">
                    <img class="responsive-img" src=${res.crestUrl.replace(
                      /^http:\/\//i,
                      "https://"
                    )} alt="${res.name}">
                  </div>
